...
export default function GetStarted() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      {/* Content */}
      <section className="relative z-10 mx-auto flex h-screen w-full max-w-5xl flex-col items-center justify-center px-6 pb-10">
          ...
          {mode === "signin" ? (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button type="submit" className="mt-6 w-full rounded-md bg-black px-3 py-2 text-xs font-medium text-white transition hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90">
                  Create Account
                </button>
              </div>
            </form>
