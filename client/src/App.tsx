...
export default function App() {
  ...
  return (
    <main className="relative min-h-screen overflow-y-auto">
      ...
      {/* Floating Stats Card - Follows Cursor */}
      <div 
        className={`fixed z-50 w-48 h-48 pointer-events-none lg:block transition-all duration-300 ease-out ${
      ...
      >
        <div className="relative rounded-xl border border-blue-200/50 bg-gradient-to-br from-white/50 via-blue-50/40 to-white/50 p-4 shadow-2xl backdrop-blur-md">
          {/* Header */}
          <div className="border-b border-blue-300/30 pb-3 mb-3">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-bold text-gray-900 flex items-center gap-1.5">
            <span className="text-blue-600">⚡</span>
            CuralynX Impact
          </h3>
          <span className="rounded-full bg-emerald-100/90 px-2 py-0.5 text-xxs font-semibold text-emerald-700 shadow-sm">
            Live
          </span>
        </div>
          </div>
        ...
        {/* Stat 1 */}
        <div className="flex items-start gap-2 p-2 rounded-lg bg-white/60 border border-gray-200/40 shadow-sm hover:shadow-md transition-shadow">
          <span className="text-lg flex-shrink-0">🩺</span>
          <div className="flex-1">
            <p className="text-xs font-bold text-gray-900">Trusted by doctors</p>
            <p className="text-xs text-gray-600">across clinics</p>
          </div>
        </div>

        {/* Stat 2 */}
        <div className="flex items-start gap-2 p-2 rounded-lg bg-white/60 border border-blue-200/40 shadow-sm hover:shadow-md transition-shadow">
          <span className="text-lg flex-shrink-0">💬</span>
          <div className="flex-1">
            <p className="text-xs font-bold text-blue-900">98% accuracy</p>
            <p className="text-xs text-blue-700">in transcription</p>
          </div>
        </div>

        {/* Stat 3 */}
        <div className="flex items-start gap-2 p-2 rounded-lg bg-white/60 border border-emerald-200/40 shadow-sm hover:shadow-md transition-shadow">
          <span className="text-lg flex-shrink-0">⏰</span>
          <div className="flex-1">
            <p className="text-xs font-bold text-emerald-900">6+ hours saved</p>
            <p className="text-xs text-emerald-700">per week</p>
          </div>
        </div>

        {/* Stat 4 */}
        <div className="flex items-start gap-2 p-2 rounded-lg bg-white/60 border border-purple-200/40 shadow-sm hover:shadow-md transition-shadow">
          <span className="text-lg flex-shrink-0">🔒</span>
          <div className="flex-1">
            <p className="text-xs font-bold text-purple-900">HIPAA-ready</p>
        ...
        <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-400/60 opacity-75"></span>
